...
return array(
    ...
    'PanierFraisesBois_Alt' => "Wild strawberry basket",
    'PanierFraisesBois_Titre' => "Wild strawberry basket",
    'PanierFraisesBois_Desc' => "Copy -1761 Jean Siméon Chardin (1699-1779 French))",
    'ReveDeTropiques_Alt' => "Tropical Dream - Young Woman and Dog on Sofa",
    'ReveDeTropiques_Titre' => "Tropical Dream",
    'ReveDeTropiques_Desc' => "",
    'Flamboyance_Alt' => "Flamboyance - abstraction - Bursts of color",
    'Flamboyance_Titre' => "Flamboyance",
    'Flamboyance_Desc' => "",
    'LesDanseusesNoires_Alt' => "The dancers: 3 black women in green dresses in front of a sunset",
    'LesDanseusesNoires_Titre' => "The dancers",
    'LesDanseusesNoires_Desc' => "Tribute to Pina Bausch The Rite of Spring and l'Ecole des Sables (Sénégal)",
    'DonazacVillage_Alt' => "Donazac - small village in the Aude at the foot of the Montagne Noire",
    'DonazacVillage_Titre' => "Donazac",
    'DonazacVillage_Desc' => "Village of the county of Razès (Southern France)",
    'ClairDeSoleil_Alt' => "Clair de Soleil - children play in the waves - Grandma watches over",
    'ClairDeSoleil_Titre' => "Sunlight",
    'ClairDeSoleil_Desc' => "Sunset on Coolangatta Beach - Queensland Australia",
    ...
    'BaignadeRiviereCudgen_Desc' => "Cudgen River, Kingscliff, NSW Australia",
